...
qplot(distribution.under.sharp.null) +
 geom_vline(aes(xintercept = ATE,color = 'ATE')) + 
  ggtitle(paste('Model: active in experiment ~ treatment, ATE = ', round(ATE,4), ', p-value = ', p_value_two_tailed, 'SE = ',round(SE,4))) + 
...
lm2 = df[phone == 1,lm(active_in_exp ~ treatment + drug_count + treatment)] # add drug_count
