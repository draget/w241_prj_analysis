...
```{r,message=FALSE,error=FALSE}
d = read.csv('~/w241/prj/w241_prj_analysis/PrelimRESULTSTD.csv')
#g1 = read.csv('~/Desktop/group1.csv')
#g2_sms = read.csv('~/Desktop/group2_SMS.csv')
#g2_no_sms = read.csv('~/Desktop/group2_NoSMS.csv')
s_prior = read.csv('~/w241/prj/w241_prj_analysis/scripts_priorTD.csv')
s_during = read.csv('~/w241/prj/w241_prj_analysis/scripts_duringTD.csv')
```
